...
// Mengambil data pembayaran dari tabel `dana_pengembangan_history`, menampilkan 20 data terakhir
$queryHistory = "
    SELECT s.nama_siswa, s.kelas, dph.tanggal_bayar, dph.id_history, dph.jumlah_bayar, dph.metode_pembayaran
    FROM dana_pengembangan_history dph
    JOIN dana_pengembangan dp ON dph.id_dana_pengembangan = dp.id_dana_pengembangan
    JOIN siswa s ON dp.id_siswa = s.id_siswa
    ORDER BY dph.tanggal_bayar DESC
    LIMIT 500
";
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Data Pembayaran Dana Pengembangan</h4>
                                </div>
                                <div class="card-body">
                                    <!-- Kolom Pencarian -->
                                        ...
                                        <table class="table table-bordered mb-0" id="tableHistory">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Tombol Cetak Nota -->
                                                        <a href="cetak_nota_dp.php?id_history=<?php echo $row['id_history']; ?>" target="_blank" class="btn btn-info btn-sm">Cetak</a>
                                                    </td>
                                                </tr>
                                                <?php endwhile; ?>
                                            </tbody>
