...
if (isset($_POST['nis'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: pembayaran_transportasi_siswa.php?id_siswa=" . $id_siswa);
        exit;
    } else {
        // Jika NIS tidak ditemukan, kembali ke halaman sebelumnya dengan pesan error
        $_SESSION['error'] = "NIS tidak ditemukan atau siswa belum terdaftar dalam layanan transportasi.";
