...
// Query untuk menampilkan 20 data terakhir dari tabel `dana_sharing_history`
$queryHistory = "
...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading text-center">
                <h3>Pembayaran Dana Sharing</h3>
            </div>
            <div class="page-content">
                <section class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        <!-- Tombol Bayar dan Pengaturan -->
                        <section class="section">
                            <div class="card">
                                <div class="card-body d-flex flex-wrap justify-content-center">
                                    ...
                                    <button class="action-button" onclick="window.location.href='setting_sharing.php'">
                        ...
                        <!-- Tabel Dana Sharing History -->
                        <section class="section">
                            <div class="card">
                            <div class="card-header table-header text-center">
                                    <h4 class="card-title">Riwayat Pembayaran Dana Sharing</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="cetak_nota_ds.php?id_history=<?php echo $row['id_history']; ?>" target="_blank" class="btn btn-info btn-sm">Cetak Nota</a>
                                                    </td>
                                                </tr>
                                                <?php endwhile; ?>
                                            </tbody>
    ...
    <div class="modal fade" id="bayarModal" tabindex="-1" aria-labelledby="bayarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="proses_nis.php" method="POST">
