...
// Query to display the last 20 records from `dana_pengembangan_history`
$queryHistory = "
    SELECT h.*, s.nama_siswa, s.kelas 
    FROM dana_pengembangan_history h
    JOIN dana_pengembangan d ON h.id_dana_pengembangan = d.id_dana_pengembangan
...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading text-center">
                <h3>Pembayaran Dana Pengembangan</h3>
            </div>
            <div class="page-content">
                <section class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-body d-flex flex-wrap justify-content-center">
                                    ...
                                    <button class="action-button" onclick="window.location.href='setting_pengembangan.php'">
                        ...
                        <!-- Table for Dana Pengembangan Payment History -->
                        <section class="section">
                            <div class="card">
                                <div class="card-header table-header text-center">
                                    <h4 class="card-title">Riwayat Pembayaran Dana Pengembangan</h4>
                                </div>
                                <div class="card-body">
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="cetak_nota_dp.php?id_history=<?php echo $row['id_history']; ?>" target="_blank" class="btn btn-info btn-sm">Cetak Nota</a>
                                                    </td>
                                                </tr>
                                                <?php endwhile; ?>
                                            </tbody>
    ...
    <div class="modal fade" id="bayarModal" tabindex="-1" aria-labelledby="bayarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="proses_nis_pengembangan.php" method="POST">
