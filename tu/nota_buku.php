...
// Mengambil data pembayaran dari tabel `buku_history`, menampilkan 500 data terakhir
$queryHistory = "
    SELECT s.nama_siswa, s.kelas, bh.tanggal_bayar, bh.id_history, bh.jumlah_bayar, bh.metode_pembayaran
    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-heading">
                <h3>Riwayat Pembayaran Buku</h3>
            </div>
            <div class="page-content">
                <section class="row">
                    <div class="col-12 col-lg-12">
                        <!-- Tabel Riwayat Pembayaran Buku -->
                                        ...
                                        <table class="table table-bordered mb-0" id="tableHistory">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- Tombol Cetak Nota -->
                                                        <a href="cetak_nota_buku.php?id_history=<?php echo $row['id_history']; ?>" target="_blank" class="btn btn-info btn-sm">Cetak</a>
                                                    </td>
                                                </tr>
                                                <?php endwhile; ?>
                                            </tbody>
