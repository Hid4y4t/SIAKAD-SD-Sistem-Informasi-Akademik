...
// Query untuk mendapatkan riwayat pembayaran dari `buku_history`, menampilkan 20 data terakhir
// Query untuk mendapatkan riwayat pembayaran dari `buku_history`, menampilkan 20 data terakhir
$queryHistory = "
    SELECT h.*, s.nama_siswa, s.kelas, s.nis, b.jenis_buku 
    FROM buku_history h
    JOIN buku_pembayaran p ON h.id_pembayaran = p.id_pembayaran
...
<body>
            ...
            <div class="page-content">
                <section class="row justify-content-center">
                    <div class="col-12 col-lg-8">
                        ...
                        <section class="section">
                            <div class="card">
                                <div class="card-body d-flex flex-wrap justify-content-center">
                                    ...
                                    <button class="action-button" onclick="window.location.href='setting_buku.php'">
                        ...
                        <!-- Table for Book Payment History -->
                        <section class="section">
                            <div class="card">
                                <div class="card-header table-header text-center">
                                    <h4 class="card-title">Riwayat Pembayaran Buku</h4>
                                        ...
                                        <table class="table table-bordered mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                    <a href="cetak_nota_buku.php?id_history=<?php echo $row['id_history']; ?>" target="_blank" class="btn btn-info btn-sm">Cetak Nota</a>
    ...
    <div class="modal fade" id="bayarModal" tabindex="-1" aria-labelledby="bayarModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="proses_nis_buku.php" method="POST">
