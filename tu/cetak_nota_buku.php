...
// Query untuk mendapatkan data nota dari `buku_history`
$query = "
    SELECT bh.*, s.nama_siswa, s.kelas, s.nis, b.jenis_buku, bp.total_tagihan, bp.jumlah_terbayar
...
$pdf->SetTitle('Nota Pembayaran Buku');
...
$html = '
    <div style="text-align: center; font-family: Arial, sans-serif;">
        ...
        <h2 style="background-color: #f2f2f2; padding: 8px; border-radius: 5px; font-size: 20px;">NOTA PEMBAYARAN BUKU</h2>
    </div>
    ...
    <table style="width: 100%; font-size: 14px;">
        <tr>
            <td style="width: 70%;"><strong>Jenis Buku</strong></td>
            <td style="width: 30%;">: ' . htmlspecialchars($nota['jenis_buku']) . '</td>
        </tr>
        <tr>
            <td style="width: 70%;"><strong>Total Tagihan Buku</strong></td>
            <td style="width: 30%;">: Rp ' . number_format($nota['total_tagihan'], 0, ',', '.') . '</td>
        </tr>
        <tr>
            <td style="width: 70%;"><strong>Total Pembayaran yang Sudah Dibayarkan</strong></td>
            <td style="width: 30%;">: Rp ' . number_format($nota['jumlah_terbayar'], 0, ',', '.') . '</td>
        </tr>
        <tr>
            <td style="width: 70%;"><strong>Jumlah Pembayaran (Cicilan)</strong></td>
...
$pdf->Output('Nota_Pembayaran_Buku.pdf', 'I');
?>
