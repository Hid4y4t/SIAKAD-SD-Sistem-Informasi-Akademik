...
// Query untuk mendapatkan data nota dari `ppdb_history`
$query = "
    SELECT h.*, s.nama_siswa, s.kelas, s.nis, pp.total_tagihan, pp.jumlah_terbayar
    FROM ppdb_history h
    JOIN ppdb_pembayaran pp ON h.id_pembayaran = pp.id_pembayaran
...
$pdf->SetTitle('Nota Pembayaran PPDB');
...
$pdf->Output('Nota_Pembayaran_PPDB.pdf', 'I');
?>
