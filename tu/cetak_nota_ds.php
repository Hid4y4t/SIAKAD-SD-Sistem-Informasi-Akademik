...
// Query untuk mendapatkan data nota dari `dana_sharing_history`
$query = "
    SELECT h.*, s.nama_siswa, s.kelas, s.nis, ds.jumlah_tagihan
    FROM dana_sharing_history h
    JOIN siswa s ON h.id_siswa = s.id_siswa
    JOIN dana_sharing ds ON h.id_dana_sharing = ds.id_dana_sharing
    WHERE h.id_history = ?
";
...
$sisa_tagihan = max(0, $nota['jumlah_tagihan'] - $nota['jumlah_bayar']);
...
$pdf->SetTitle('Nota Pembayaran Dana Sharing');
...
$html = '
    <div style="text-align: center; font-family: Arial, sans-serif;">
        ...
        <h2 style="background-color: #f2f2f2; padding: 8px; border-radius: 5px; font-size: 20px;">NOTA PEMBAYARAN DANA SHARING</h2>
    </div>
    ...
    <table style="width: 100%; font-size: 14px;">
        ...
        <tr>
            <td style="width: 68%;"><strong>Sisa Tagihan </strong></td>
...
$pdf->Output('Nota_Pembayaran_Dana_Sharing.pdf', 'I');
